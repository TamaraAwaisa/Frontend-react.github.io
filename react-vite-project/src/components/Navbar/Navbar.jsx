        ...
        <AppBar position="fixed" sx={{ backgroundColor: 'white' }}>
            <Container maxWidth="xl">
                ...
                <img
                    ...
                    alt="Logo"
                    style={{ display: { xs: 'none', md: 'flex' }, mr: 1, width: '50px', height: '50px', }}
                />
                ...
                <IconButton onClick={handleClickAddToCart}>
                    <StyledBadge badgeContent={anchorElAddToCart} color="secondary">
                        <ShoppingCartTwoToneIcon sx={{color: 'gray', p: '3px'}} />
                    </StyledBadge>
                </IconButton>
                </Toolbar>
            </Container>
